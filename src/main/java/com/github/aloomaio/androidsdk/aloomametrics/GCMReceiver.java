...
import com.github.aloomaio.androidsdk.aloomametrics.AloomaAPI.InstanceProcessor;
...
* the device status bar. Together with {@link AloomaAPI.People#initPushHandling(String) }
...
* get set up Mixpanel messages is call {@link AloomaAPI.People#identify(String) }
* with a distinct id for your user, and call {@link AloomaAPI.People#initPushHandling(String) }
* with the your Google API project identifier.
* <pre>
* {@code
*
* AloomaAPI.People people = mMixpanelAPI.getPeople();
...
* {@link AloomaAPI.People#setPushRegistrationId(String)}
* in your own REGISTRATION handler.
*
* @see AloomaAPI#getPeople()
* @see AloomaAPI.People#initPushHandling(String)
...
public class GCMReceiver extends BroadcastReceiver {
    ...
    private Notification buildNotification(Context context, Intent inboundIntent, ResourceIds iconIds) {
        ...
        if (AConfig.DEBUG) Log.d(LOGTAG, "MP GCM notification received: " + notificationData.message);
    ...
    private void handleRegistrationIntent(Intent intent) {
        ...
        if (intent.getStringExtra("error") != null) {
            ...
            if (AConfig.DEBUG) Log.d(LOGTAG, "Registering GCM ID: " + registration);
            ...
            if (AConfig.DEBUG) Log.d(LOGTAG, "Unregistering from GCM");
            AloomaAPI.allInstances(new InstanceProcessor() {
                @Override
                public void process(AloomaAPI api) {
    ...
    private void handleNotificationIntent(Context context, Intent intent) {
        final AConfig config = AConfig.getInstance(context);
    ...
    private static final String LOGTAG = "AloomaAPI.GCMReceiver";
}
